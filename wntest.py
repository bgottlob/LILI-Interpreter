    ...
    for line in unknown_words_file:
        ...
        for known_tuple in known_words:
            ...
            if unknown in known_synset.lemma_names():
                ...
                for unknown_synset in wn.synsets(unknown, pos):
...
def filter_results(results_list, threshold):
    ...
    Given a list of C{SemanticSimilarityResult} objects and a threshold value, filters the list removing result objects with semantic similarity scores less than the threshold. Returns the filtered list.
